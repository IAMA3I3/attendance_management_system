...
<body>
    <div class="dashboard">
        ...
        <div class="body">
            ...
            <!--  -->
            <div class="mb-lg"></div>
            <div class="font-xl mb">Manage Site</div>
            <!--  -->
            <button class="btn-outline" id="pop-btn"><i class="fa-solid fa-plus"></i>Add Site</button>
            <!--  -->
            <div class="pop-form-container <?php echo (isset($_SESSION["add_site_errors"]) || isset($_GET["edit"])) ? 'pop' : ''; ?>">
                <div class="pop-form">
                    <!--  -->
                    <form action="./includes/edit_site/unset_edit.php" method="post">
                    ...
                    <!--  -->
                    <div class="font-lg mb"><?php echo (isset($_GET["edit"])) ? 'EDIT SITE' : 'ADD SITE'; ?></div>
                    <!--  -->
            ...
            <div class="card">
                <div class="font-lg mb">SITES</div>
                <!--  -->
                <table class="mb">
                    <tr class="bold-text">
                        <td>Site Name</td>
...
<?php
if (isset($_SESSION["add_site_errors"])) {
