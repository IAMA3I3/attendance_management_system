...
// empty input
function empty_input(string $first_name, string $last_name, string $email, string $pwd, string $confirm_pwd)
{
    if (empty($first_name) || empty($last_name) || empty($email) || empty($pwd) || empty($confirm_pwd)) {
        return true;
    } else {
        return false;
    }
